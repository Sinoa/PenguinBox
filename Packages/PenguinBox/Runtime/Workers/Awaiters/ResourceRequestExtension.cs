...
{
    /// <summary>
    /// ResourceRequest クラスの拡張関数実装クラスです
    /// </summary>
    public static class ResourceRequestExtension
    {
        /// <summary>
        /// ResourceRequest の待機オブジェクトを取得します
        /// </summary>
        /// <param name="request">待機する ResourceRequest</param>
        /// <returns>ResourceRequest の待機オブジェクトを返します</returns>
